  ...
  return (
    <div className={classes.wrapper}>
      <div className={classes.wrapperImg}>
        ...
        <button type="submit" className={classes.button} ant-click-animating-without-extra-node="false" onClick={() => history.push('/actions/eventCreate')}>
          Створити подію 
        </button>
      </div>
      ...
      <div className={classes.wrapperCol}>
        <div className={classes.wrapper}>
          ...
          <div className={classes.wrapper3}>
            ...
            <div className={classes.line}/>
            <h2>3 події</h2>
            <button type="submit" className={classes.button} ant-click-animating-without-extra-node="false" onClick={() => setModalVisible(true)}>Список</button>
            <Modal
            ...
            >
              ...
              <button type="submit" className={classes.button} ant-click-animating-without-extra-node="false" id={classes.button} onClick={() => history.push('/actions/eventinfo/1')}>
                Деталі
              </button>
              <hr/>
        ...
        <div className={classes.wrapper4}>
          ...
          <div className={classes.line}/>
          <h2>2 події</h2>
          <button type="submit" className={classes.button} ant-click-animating-without-extra-node="false" onClick={() => setModal2Visible(true)}>Список</button>
          <Modal
