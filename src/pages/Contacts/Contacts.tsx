    ...
    return (
        <Layout.Content className={classes.contacts}>
            <section className={classes.contactsList}>
                <h1><InfoOutlined style={{fontSize: '32px'}}/>Контакти</h1>
                <List
            ...
            <Form className={classes.contactsForm} layout="vertical"   initialValues={{prefix: '+380'}} validateMessages={validateMessages}>
